...
//! Need to use Bicycle Model to identify turn rate
...
//! Reduce speed of car based on Turning
...
//! What is a spped index used for?
...
//! You could just have a look up table for this
...
//! Lower Threshold and higher Threshold based on Speed
...
int VFH_Algorithm::Init()
{
  ...
  CENTER_X = (int)floor(WINDOW_DIAMETER / 2.0); // Center Cell
  CENTER_Y = CENTER_X;
 ...
 * @param chosen_turnrate the chosen turn rate to drive the robot
 * @return 1
 */
